    ...
    def save_txt(self, txt_file, save_conf=False):
        ...
        if probs is not None:
            ...
            for j, d in enumerate(boxes):
                ...
                # print("............shape................", self.orig_shape)
                # print("............xywh................", d)
                # seg = np.array(list(map(lambda x: x * self.orig_shape[0], seg)))
                # line = (*seg, )
                # print("............seg.22.................", line)
                ...
                if masks:
                    ...
                    seg = masks[j].xy[0].copy().reshape(-1)  # reversed mask.xyn, (n,2) to (n*2)
                    # print("..........masks[j]...................", masks[j])
                    # print("..........seg...................", seg)
                    line = (*seg,)
                if kpts is not None:
